...
## Iniialize camera or a video file
...
## Camera frame or target image input
...
## Creating a bounding polygon with 4 points
img2 = cv2.polylines(img2,[np.int32(dst)],True,4,4, cv2.LINE_AA)

## Draw the matched keypoints between the images
